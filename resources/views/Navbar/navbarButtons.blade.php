...
<div class="mb-2">
    <a href="{{ route('category.create') }}" class="
        mr-2 text-white bg-purple-700 hover:bg-purple-800 focus:outline-none
        focus:ring-4 focus:ring-purple-300 font-medium rounded-full
        text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700
        dark:focus:ring-purple-900">
        <i class="fa fa-add mr-2 mt-1"></i>Ajouter une catégorie de produits
    </a>
    <a href="{{ route('list.create') }}" class="
        mr-2 text-white bg-purple-500 hover:bg-purple-800 focus:outline-none
        focus:ring-4 focus:ring-purple-300 font-medium rounded-full
        text-sm px-5 py-2.5 text-center dark:bg-purple-600 dark:hover:bg-purple-700
        dark:focus:ring-purple-900">
        <i class="fa fa-add mr-2 mt-1"></i>Ajouter une liste
    </a>
    @if(count($categories) > 0)
        <a href="{{ route('product.create') }}" class="
            ...
            dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 text-center">
            <i class="fa fa-add mr-2 mt-1"></i>Ajouter un produit
        </a>
    @endif
</div>
