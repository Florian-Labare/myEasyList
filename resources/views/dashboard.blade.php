@section('content')
    <section class="container px-4 mx-auto mt-6">
        ...
        @endif
        <h2 class="ml-5 mt-10 mb-4 text-4xl leading-none tracking-tight text-left text-gray-500 md:text-5xl lg:text-6xl dark:text-white p-6">Vos catégories de produits</h2>
        <div class="p-6 pl-6 bg-white-100 flex items-center justify-center">
            <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-4 md:justify-items-center">
                @foreach($categories as $category)
                    <a href="{{ route('products.category', ['categoryId' => $category->id]) }}" class="sm:grid-cols-1 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 p-4 mr-3 mb-3 w-80 justify-between">
    ...
    <div id="lists" class="w3-container tab" style="display:none">
        <h2 class="ml-5 mt-10 mb-4 text-4xl leading-none tracking-tight text-left text-gray-500 md:text-5xl lg:text-6xl dark:text-white p-6">Vos listes</h2>
        <div class="p-6 pl-6 bg-white-100 flex items-center justify-center">
            <div class="grid xl:grid-cols-4 lg:grid-cols-2 md:grid-cols-1 sm:grid-cols-1 gap-4 md:justify-items-center">
                @foreach($lists as $list)
                    <a href="{{ route('list.show', ['listId' => $list->id]) }}" class="sm:grid-cols-1 flex flex-col items-center bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 p-4 mr-3 mb-3 w-80 justify-between">
                        <div class="flex flex-col justify-between p-4 leading-normal">
